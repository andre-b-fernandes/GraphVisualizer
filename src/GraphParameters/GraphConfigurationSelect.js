...
import GraphErdosRenySelect from './GraphErdosRenySelect'
    ...
    render(){
        return(
            <div hidden={this.props.hidden}>
                ...
                <GraphErdosRenySelect keyName={this.props.keyName} hidden={this.props.model !== RANDOM_GRAPH_ERDOS_KEY} updateParameterInformation = {this.props.updateParameterInformation} maxEdges={this.props.maxEdges} ></GraphErdosRenySelect>
